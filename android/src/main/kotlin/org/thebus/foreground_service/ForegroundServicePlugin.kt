...
class ForegroundServicePlugin : FlutterPlugin, MethodCallHandler, IntentService("org.thebus.ForegroundServicePlugin") {
        ...
        if (myApplicationContextRef?.get() != null) {
            ...
            try {
                when (call.method) {
                    ...
                    "setUploadProgress" ->
                        notificationHelper.uploadProgress = (call.arguments as JSONArray).getInt(0)

                    //------------------------------

                    "setEnableUploadProgress" ->
                        notificationHelper.changeEnableProgress((call.arguments as JSONArray).getBoolean(0))
                ...
                if (methodCallResult != null) {
                    result.success(methodCallResult)
                }
    ...
    class NotificationHelper(val notificationId: Int = 1) {
        ...
        private val builder: NotificationCompat.Builder by lazy {
            ...
            try {
                ...
                if (enableUploadProgress) {
                    newBuilder.setProgress(100, 0, false)
                }
        ...
        private var enableUploadProgress: Boolean = false

        var uploadProgress: Int = 0
            set(value) {
                if (value !in 0..100) {
                    print("Progress may be 0..100 !!!!!!!!!!!")
                } else {
        ...
        fun changeEnableProgress(isEnable: Boolean) {
            enableUploadProgress = isEnable
            maybeUpdateNotification()
        }
    }
}
